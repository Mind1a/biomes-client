          ...
          <div className='xl:max-w-230 px-4 xl:px-6 flex  flex-col gap-6 w-full '>
            ...
            <BiomesDetailView
              ...
              data={{
                ...
                imageArr: [
                  { id: 1, src: '/assets/images/img.png' },
                  { id: 2, src: '/assets/images/img.png' }
                ],
                description: (
                  <p>აქ ჩაიწერება მდებარეობის სტატიკური ტექსტი...</p>
                )
              }}
            />
            ...
            <BiomesDetailView
              ...
              data={{
                ...
                description: (
                  <p>აქ ჩაიწერება ჰავის სტატიკური ტექსტი...</p>
                )
              }}
            />
            ...
            <BiomesDetailView
              ...
              data={{
                ...
                imageArr: [],
                description: (
                  <p>აქ ჩაიწერება ნიადაგის სტატიკური ტექსტი...</p>
                )
              }}
            />
            ...
            <BiomesDetailView
              ...
              data={{
                ...
                imageArr: [
                  { id: 1, src: '/assets/images/img.png' },
                  { id: 2, src: '/assets/images/img.png' },
                  { id: 3, src: '/assets/images/img.png' },
                  { id: 4, src: '/assets/images/img.png' }
                ],
                description: (
                  <p>
            ...
            <BiomesDetailView
              ...
              data={{
                ...
                imageArr: [],
                description: (
                  <p>აქ ჩაიწერება გაბატონებული სასიცოცხლო ფორმების სტატიკური ტექსტი...</p>
                )
              }}
            />
            ...
            <BiomesDetailView
              ...
              data={{
                ...
                imageArr: [],
                description: (
                  <p>აქ ჩაიწერება საყურადღებო მცენარეების სტატიკური ტექსტი...</p>
                )
              }}
            />
